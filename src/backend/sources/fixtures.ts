 ...
 *  - country arrives as a clean name, an Amazon "Reviewed in X on …" blob
 *    (under `location`), or is missing entirely
...
export const FIXTURE_REVIEWS: RawReview[] = [
  ...
  },
  {
    ...
    rating: "3",
    title: null,
    // country intentionally missing -> normalizer keeps it null
  ...
  },
  {
    ...
    author: "Sofia M.",
    // messy Amazon-style blob -> parseCountry extracts "Australia"
    location: "Reviewed in Australia on 1 July 2026",
  ...
  },
  {
    ...
    author: "Carlos D.",
    // another messy blob, with a leading "the" -> parseCountry -> "United States"
    location: "Reviewed in the United States on 20 June 2026",
